...
public class week2lab {
	...
	public static void main(String[] args) {
		...
		System.out.println(age >= 16); // boolean came back as false
				System.out.println(age >= 16); // boolean came back as true
		...
		//		a. Change the value of age and rerun to see the result
				...
				//}
				//printed You can drive
				// changes age to 14 and resulted in You cannot drive
				...
				boolean hasLicense = true;
						if (age >= 16 && hasLicense) {
							System.out.println("You can drive");
								...
								System.out.println("You cannot drive");
							} //first time said You cannot drive because age is at 14
						// changes age to 18 and You can drive resulted
		...
		//		c. Change the values and note the different results.
						...
						//when the values were cost 3.50 and thirst at 4, no thanks printed
						//when values were 2.25 and 8, it printed Milk Please
